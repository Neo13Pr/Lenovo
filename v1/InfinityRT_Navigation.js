...
//    this._panMax = [25, 15];    //[right, top];
//    this._panMin = [-25, -1.37];  //[left, bottom];
    
    this._panMax = [35, 15];    //[right, top];
    this._panMin = [-35, -2.8];  //[left, bottom];
}
    ...
    if (this._navMode == 0 || this._navMode == 2) {
        if (this._navMode == 2) {
            ...
            if (this._navDXAng != 0.0 || this._navDYAng != 0.0 || this._navDPan[0] != 0.0 || this._navDPan[1] != 0.0 || this._navDDolly != 0.0) {
                ...
                var fRotMinLimit = -dollyfrac*(M_PI*0.003);
