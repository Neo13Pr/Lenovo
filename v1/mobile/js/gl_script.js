...
function UiLoader(){
	...
	$("#Think_smart img").attr("src", "./images_gl/ThinkSystem_Logo.svg");
   /* $(".productName img").attr("src", "./images_gl/ThinkSystem_Logo.svg");*/
    $("#point7image1 img").attr("src", "./images_gl/01.svg");
    $("#point7image3 img").attr("src", "./images_gl/03.svg");
    $("#point7image4 img").attr("src", "./images_gl/04.svg");
    $("#point7image5 img").attr("src", "./images_gl/05.svg");
    $("#point7image6 img").attr("src", "./images_gl/06.svg");
    $("#point7image7 img").attr("src", "./images_gl/07.svg");
    $("#point6image2 img").attr("src", "./images_gl/Cloud_Enabled_new.svg");
    $("#pauseplayImg img").attr("src", "./images_gl/Play.svg");
 /*   $("#hotspot7 img").attr("src", "./images_gl/Line_04.png");
    $("#hotspot8 img").attr("src", "./images_gl/Line_05.png");
    $("#hotspot3 img").attr("src", "./images_gl/Line_06.png");
    $("#hotspot4 img").attr("src", "./images_gl/Line_03.png");
    $("#hotspot5 img").attr("src", "./images_gl/Line_02.png");
    $("#hotspot6 img").attr("src", "./images_gl/Line_01.png");
    $("#hotspot1 img").attr("src", "./images_gl/Line_06.png");
    $("#hotspot2 img").attr("src", "./images_gl/Line_03.png");
*/

	$("#hamb img").attr("src", "./images_gl/hamburger.png");
	$("#lenovo_logo img").attr("src", "./images_gl/Lenovo.png");
	$("img#nw").attr("src", "./images_gl/white_close.png");
...
function SuperblazeStart(gl) {
    ...
    if ((navigator.userAgent.indexOf("iPhone") != -1) || ((navigator.userAgent.indexOf("Android") != -1) || (navigator.userAgent.indexOf("Mobile") != -1)) || (navigator.userAgent.indexOf('iPod') != -1)) {
        ...
        scene = new infinityrt_scene(gl, "../model_gl_mob/", canvas.width, canvas.height);
        console.log("mob");
    } else {
...
// alert("Resize page width: "+width+" height: "+height);
	...
	if(window.innerHeight>window.innerWidth || width<height){
       ...
       $("#torotate").css("display","none");
      /* $("#fullScreen").css("display","block");*/
	   /*$("#top_patch").css("display","block");*/
       ...
       /* for(i = 1; i<=15 ; i++){
            $("#colors"+i).css("display","block");
        }*/
    }else{
        potrait = false;
		reversAll();
		/*  $("#top_patch").css("display","none");*/
        $("#menubar").css("display","none");
		$("#menu1").css("display","none");
		$("#reset").css("display","none");
        $("#torotate").css("display","block");
		/*$("#fullScreen").css("display","none");*/
		/*$("#lenovo_logo").css("display","none");*/
...
function smpsAndProcessors(){
     scene.animPlayInTime("Smps_a", 0, 0);
    		scene.animPlayInTime("Smps_b", 0, 0);
     scene.animPlayInTime("Heat_sink_1", 0, 0);
}
function reverseServerCover(){
	scene.instanceSet("Left_side_cover", "visible", true);
	scene.animPlayInTime("Left_side_cover", 0, 1);
	scene.clearRefine();
}
function reversehdd(){
	scene.animPlayInTime("hdd_2_5_2", 0 , 1);
	scene.instanceSet("hdd_copys", "visible", false);
    scene.instanceSet("hdd_cap", "visible", true);
}
function reverseFrontCap(){
	_frontCapOn = false;
	scene.animPlayInTime("front1", 0, 1);
	scene.clearRefine();
}
var _frontCapOn = false;
...
//                   if(!animStoped) return;
	   ...
	   objectHide();
    	...
    	reversehdd();
    	_OpenCloseOn = false;
    	scene.instanceSet("hdd_cap", "visible", false);
    	//$("#openCloseDiv").css('backgroundColor', 'transparent');//$("#openCloseDiv").css('color', '#EC3729');
    	/*$("#menu12 .menuText").html(btnOpen);*/
        smpsAndProcessors();
    	scene.gotoPosInTime(6.183185307179579,-1.3877787807814457e-17,2.0653975890000034,1.2290757440268802,-2.6645352591003757e-15, 1200, function(){
                
				console.log('first gotopos');
    		if(_frontCapOn){
                //console.log("point1-if");
				$("#pointtext1").fadeIn(300);
    			setTimeout(function() {
	    			translateIn(1);
	    		}, 100);
				setTimeout(function() {
               ...
               // console.log("point1-else");
    			scene.animPlayInTime("front1", 1, 2000, function(){
					$("#pointtext1").fadeIn(300);
    				setTimeout(function() {
		    			translateIn(1);
    ...
    for (var j = 1; j <= 10; j++) {translateOut(j);}
     scene.decodeDeferredGeometry('DVD_rom');
       scene.decodeDeferredGeometry('HDD_group');
    	...
    	//$("#openCloseDiv").css('backgroundColor', 'transparent');//$("#openCloseDiv").css('color', '#EC3729');
    	/*$("#menu12 .menuText").html(btnOpen);*/
    	scene.instanceSet("hdd_copys", "visible", true);
    	scene.instanceSet("hdd_cap", "visible", false);
    smpsAndProcessors();
    	scene.gotoPosInTime(6.1672486953165855,0.1936770084660042,-7.8059605559333205,-2.8,-2.61160885802018, 1200, function(){
    		...
    		if(_frontCapOn){
    			...
    			_frontCapOn = true;
    			scene.animPlayInTime("hdd_2_5_2", 1, 1000, function(){
    				animComplete();
    			});
    		} else {
				$("#point2text").css('display','block');
    			scene.animPlayInTime("front1", 1, 1000, function(){
					_frontCapOn = true;
    				scene.animPlayInTime("hdd_2_5_2", 1, 1000, function(){
						animComplete();
					});
...
//    isExpanded1 = true;
      for (var j = 1; j <= 10; j++) {translateOut(j);}
        ...
        $("#menu12 .menuText").html(btnOpen);
        smpsAndProcessors();
        scene.gotoPosInTime(3.334768565129589,-0.00942477796076938,-4.260419835825806,1.118949095766666,-1.4196221902218165, 1200, function(){
			 $("#pointtext3").fadeIn(300);                         
            setTimeout(function() {
                translateIn(3);
...
//            for (var i = 6; i <= 19; i++) {$("#line"+ i + "Div").css('display','block');}
            if(autoplayAnim){
                animCompeteAuto();
            }else{
                autoPauseAllAnimations();
...
$(".menuitems").removeClass('active');
        ...
        $("#pauseplayImg2 img").attr("src" ,"./images_gl/Pause.svg").css("height","45px");
...
function autoPauseAllAnimations(){
    ...
    $("#pauseplayImg img").attr("src" ,"./images_gl/Play.svg").css("height","45px");
...
function objectHide(){
	...
	scene.instanceSet("dull_black_hide1","visible",true);
	scene.instanceSet("cords","visible",true);
	scene.instanceSet("cords_Ref","visible",true);
	scene.animPlayInTime("SIDE", 0, 0);
	scene.animPlayInTime("Screen_part",0,0);
	scene.animPlayInTime("cord_anim1", 0, 0);
	scene.animPlayInTime("cord_anim2", 0, 0);
	scene.animPlayInTime("barrier", 0, 0)
	scene.animPlayInTime("cap", 0, 0)
	scene.animPlayInTime("cord_anim1_ref", 0, 0);
	scene.animPlayInTime("cord_anim2_ref", 0, 0);
	scene.animPlayInTime("barrier_ref", 0, 0)
	scene.animPlayInTime("cap_ref", 0, 0)
	scene.animPlayInTime("Screen_part",0,0);
	$("#Menu6text").fadeOut(200);
	$("#Menu5text").fadeOut(200);
	$("#Menu5text").fadeOut(0);
    $("#Menu3text").fadeOut(200);
    
    scene.instanceSet("SERVER_D1212_01", "visible", false);
    scene.instanceSet("SERVER_D1212_02", "visible", false);
    scene.instanceSet("SERVER_D1212_03", "visible", false);
    scene.instanceSet("SERVER_D1212_04", "visible", false);
    scene.instanceSet("SERVER_D1212_05", "visible", false);
    scene.instanceSet("SERVER_D1212_06", "visible", false);
    scene.instanceSet("SERVER_D1212_07", "visible", false);
    scene.instanceSet("X3650_m5", "visible", false);
    scene.instanceSet("cables", "visible", false);*/
...
function hotspotPosAsignment() {
     ...
     pos2Dpoint14 = scene.projectPoint(scene.getObjectLocation("hotspot_14Shape-0", true));
	   ...
	   var leftPosPoint14 = (pos2Dpoint14[0] * 50) + 47.4;
	
	
	
	   var toptPosPoint1 = -((pos2Dpoint1[1] * 50) - 65);
	   var toptPosPoint2 = -((pos2Dpoint2[1] * 50) - 15);
	   var toptPosPoint3 = -((pos2Dpoint3[1] * 50) - 47.5);
	   var toptPosPoint4 = -((pos2Dpoint4[1] * 50) - 64.5);
	   var toptPosPoint5 = -((pos2Dpoint5[1] * 50) - 94.5);
	   var toptPosPoint6 = -((pos2Dpoint6[1] * 50) - 80.5);
	   var toptPosPoint7 = -((pos2Dpoint7[1] * 50) - 68.5);
	   var toptPosPoint8 = -((pos2Dpoint8[1] * 50) - 43.5);
	   var toptPosPoint9 = -((pos2Dpoint9[1] * 50) - 45.5);
	   var toptPosPoint10 = -((pos2Dpoint10[1] * 50) - 67.1);
	   var toptPosPoint11 = -((pos2Dpoint11[1] * 50) - 72);
	   var toptPosPoint12 = -((pos2Dpoint12[1] * 50) - 74);
	   var toptPosPoint13 = -((pos2Dpoint13[1] * 50) - 72);
	   var toptPosPoint14 = -((pos2Dpoint14[1] * 50) - 66.7);
...
console.log("fn call in ");
             ...
             $(document).find("message").each(function(){
             	...
             	var welcome = $(this).find('welcome').text();
             	$('#wellcomeMessage p').append(welcome);
             	var onloadCopy = $(this).find('onloadCopy').text();
             	$('#onloadCopy p').append(onloadCopy);
                 var subHeading = $(this).find('subHeading').text();
             	$('#topheading').append(subHeading);
             	 var point0text1 = $(this).find('point0text1').text();
				  $('#onloadCopy ul li:nth-child(1)').append(point0text1);
				   
				  var point0text2 = $(this).find('point0text2').text();
				  $('#onloadCopy ul li:nth-child(2)').append(point0text2);
				   
				  var point0text3 = $(this).find('point0text3').text();
				  $('#onloadCopy ul li:nth-child(3)').append(point0text3);
				   
				  var point0text4 = $(this).find('point0text4').text();
				  $('#onloadCopy ul li:nth-child(4)').append(point0text4);
             });
...
//             $(document).find("firsttext").each(function(){ 
//             	var one = $(this).find('headingText').text();
//             	$('#firsttext p:nth-child(1)').append(one);
//                var two = $(this).find('point1text1').text();
//                $('#firsttext p:nth-child(2)').append(two);
//                var three = $(this).find('point1text2').text();
//                $('#firsttext p:nth-child(3)').append(three);
//             });

             $(document).find("point2text").each(function(){
             	var point2_1 = $(this).find('headingText').text();
             	$('#point2text p:nth-child(1)').append(point2_1);
             	var point2_2 = $(this).find('point2text1').text();
             	$('#point2text p:nth-child(2)').append(point2_2);
             	var point2_3 = $(this).find('point2text2').text();
